    ...
    <div dir="rtl" className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            { label: 'إجمالي الفروع', value: branches.length, icon: '🏪', color: 'border-sky-500 bg-sky-50 text-sky-700' },
            { label: 'فروع نشطة', value: active, icon: '✅', color: 'border-emerald-500 bg-emerald-50 text-emerald-700' },
            { label: 'فروع معطّلة', value: inactive, icon: '❌', color: 'border-red-500 bg-red-50 text-red-700' },
          ].map(s => (
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-3 mt-0.5">
                      ...
                      {b.user_profiles?.full_name && (
                        <span className="text-xs text-slate-400">👤 {b.user_profiles.full_name}</span>
                      )}
                    </div>
                  </div>
